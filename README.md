...
- **Spoiler Shield**, streams run 20 to 80s behind the data feed, so second screens normally score before your TV. Terrace lets you delay match events (15/30/60s) so it celebrates *with* your TV, not before it. No incumbent does this.
